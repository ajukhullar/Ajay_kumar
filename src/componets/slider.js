          ...
          <Carousel fade id="home">
            <Carousel.Item>
              ...
              <Carousel.Caption>
                ...
                <small>
                  I'm Passionate{" "}
                  <strong className="primary">Web designer</strong>
                </small>
                <Nav className="text-center justify-center">
                  ...
                  <Nav.Link
                    className="btn btn-primary text-white m-1"
                    href="https://drive.google.com/file/d/1DlRIpJ8wb2yxYKQzEdN9YDRpNQ4L53L0/view?usp=sharing"
                    target="blank"
                  >
                    Download
                  </Nav.Link>
            ...
            <Carousel.Item>
              ...
              <Carousel.Caption>
                ...
                <Nav className="text-center justify-center">
                  ...
                  <Nav.Link
                    className="btn btn-primary text-white m-1"
                    href="https://drive.google.com/file/d/1qOnDXno2qITiU6gknDMEjM-3PmImNlPC/view?usp=sharing"
                    target="blank"
                  >
                    Download
                  </Nav.Link>
